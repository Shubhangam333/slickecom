            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#657789" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="feather feather-search"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
              ...
              {userInfo && userInfo.isAdmin && (
                <NavDropdown title="ADMIN" id="adminmenu" className="pr-5">
                  <LinkContainer to="/admin/graphModel">
                    <NavDropdown.Item>ProductGraph</NavDropdown.Item>
                  </LinkContainer>
                  <LinkContainer to="/admin/payMethGraph">
                    <NavDropdown.Item>PaymentChoiceGraph</NavDropdown.Item>
                  </LinkContainer>
                  <LinkContainer to="/admin/priceGraph">
                    <NavDropdown.Item>PriceGraphModel</NavDropdown.Item>
                  </LinkContainer>

                  <LinkContainer to="/admin/ratingGraph">
                    <NavDropdown.Item>RatingGraph</NavDropdown.Item>
                  </LinkContainer>
                  <LinkContainer to="/admin/reviewGraph">
                    <NavDropdown.Item>ReviewGraph</NavDropdown.Item>
                  </LinkContainer>

                  <LinkContainer to="/admin/userGraph">
                    <NavDropdown.Item>UserGraph</NavDropdown.Item>
                  </LinkContainer>
